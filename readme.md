...
The de-blurred result is also not promising and while imposing hyper-Laplacian norm $L_p$ ($0<p<1$) as the regularizer (penalty term), the `scipy` optimizer module could fail to find the correct result. 
